...
published: 2022-03-14T21:18:38+08:00 #发布时间
tags: [ "PowerShell","美化","教程" ] #tags
categories: [ "PowerShell", "美化" ] #关键字
...
![最终效果](./WindowsTerminal_yHb2JTB5ix.png)
...
打开 Windows Terminal 配置文件, 编辑`profiles.defaults`节点
...
``` powershell
Set-PSReadLineOption -PredictionSource History # 启用历史记录
Set-PSReadlineKeyHandler -Chord Tab -Function MenuComplete # 在当按Tab补全时, 显示候选项
```

#### pwsh快捷键

`Ctrl+空格` 显示候选命令
![效果](./WindowsTerminal_epoxvJdX7d.png)
...
![效果](./WindowsTerminal_eRMTPOMGij.png)
